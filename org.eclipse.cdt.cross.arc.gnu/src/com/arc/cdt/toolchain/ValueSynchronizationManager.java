...
public class ValueSynchronizationManager extends AbstractOptionEnablementManager {

	public ValueSynchronizationManager() {
	...
	class Observer implements IObserver {
        ...
        public void onOptionValueChanged(IOptionEnablementManager mgr, String optionId) {
            if (initializing || !getOptionIds().contains(optionId)) {
                return;
            }
